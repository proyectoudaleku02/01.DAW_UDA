...
public class PanInicio extends javax.swing.JPanel {
     ...
     */
    public PanInicio(String provincia, boolean periodoInscricion, boolean sorteo) {
        initComponents();
        
        switch(provincia.toUpperCase()){
            case "ARB":
                lAraba.setVisible(true);lBizkaia.setVisible(false);lGipuzkoa.setVisible(false);
                break;
            case "BZK":
                lAraba.setVisible(false);lBizkaia.setVisible(true);lGipuzkoa.setVisible(false);
                break;
            case "GZK":
                lAraba.setVisible(false);lBizkaia.setVisible(false);lGipuzkoa.setVisible(true);
                break;
        }
    }
